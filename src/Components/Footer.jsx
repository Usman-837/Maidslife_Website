    ...
    return (
        <div className='flex items-center justify-center bg-[#212121] py-2 px-4'>
            <div className='max-w-container w-full text-white'>
                <div className='flex justify-between max-md:grid max-md:grid-cols-2 max-sm:grid-cols-1'>
                ...
                <div className='border-t border-gray-700 mt-6 pt-4 pb-2 flex items-center justify-between max-md:grid max-md:grid-cols-2 max-md:gap-y-10 max-sm:grid-cols-1'>
