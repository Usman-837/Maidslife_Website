...
const Mobileapp = () => {
  return (
    <div className='flex items-center justify-center'>
      <div className='max-w-container w-full pt-10 flex justify-between'>
        <div className='max-w-[570px] w-full'>
          <span className='text-[#00000061] mb-2'>Download our Super app!</span>
          <p className='text-3xl font-semibold'>Manage all to-dos with a single tap!</p>
          ...
          <div className='flex my-8 gap-x-9'>
